...
static double findSmallestDouble(double array[], double low, double high);
static void swapIntegerElements(int array[], int p1, int p2);
static void swapDoubleElements(double array[], int p1, int p2);
...
void sortDoubleArray(double array[], int n) {
    ...
    for (lh = 0; lh < n; lh++) {
        rh = findSmallestDouble(array, lh, n-1);
        swapDoubleElements(array, lh, rh);
    }
}
